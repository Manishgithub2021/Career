...
**REACT****
1. EXPENSE TRACKER
   https://expensetracker-3e27f.firebaseapp.com/

2. TODOLIST
https://react-http-37a2c.firebaseapp.com/

3. BACKWARD FORWARD COUNTER 
https://counter-1a5fa.firebaseapp.com/

4. WEATHER API
   https://cityweather-58ab3.web.app/
...
4. DEVELOPER BOARD : A mongoDB,NODE,Express based application where one can login,and send queries ,and someone can reply on top of that(something like whatsapp) 
